...
const ProfilePage = () => {
  ...
  const getMovieRequest = async (searchValue) => {
    const url = `http://www.omdbapi.com/?s=${searchValue}&apikey=58a55ee1`;
    ...
    return isAuth ? (
        ...
        <div className='container'>
            ...
            <div className="profile">
                <h3 className='profile-title'>Личный кабинет</h3>
                <div className="flex">
                    <FontAwesomeIcon className='letter-icon' icon={faEnvelope} />
                    <p className='profile-email'>{email}</p>
                </div>
                
                <div className='row d-flex align-items-center mt-4 mb-4'>
      <MovieListHeading heading = 'Cписок фильмов в избранном' />
      </div>
